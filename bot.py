...
async def provide_referral_link(message: types.Message):
    ...
    await message.answer(f"🤝Tabriklaymiz, siz tanlovda qatnashish uchun muvaffaqiyatli ro‘yxatdan o‘tdingiz."
                         f" \n\n 👩‍💻Tanlovning birinchi bosqich g'oliblari eng ko'p referal to'plagan ishtirokchilar o'rtasida aniqlanadi. Tanlovning ikkinchi bosqichi g'oliblar eng ko'p referal to'plagan ishtirokchilar o'rtasida o'tkaziladigan mantiqiy savollarga to'g'ri javob berish orqali aniqlanadi. \n\n 1-o'rin - 300000 so'm \n 2-o'rin - 200000 so'm \n 3-o'rin - 100000 so'm \n\n Rag'batlantiruvchi o'rinlar egalariga esa turli (1 oylik va 3 oylik telegram premium) sovg'alar topshiriladi.\n\n Sizning referal linkingiz: {referral_link}",
...
async def invite_friends(message: types.Message):
    bot_info = await bot.get_me()
    referral_link = f"https://t.me/{bot_info.username}?start={message.from_user.id}"
    await message.answer(f"🥳 Tanlovning birinchi bosqich g'oliblari eng ko'p referal to'plagan ishtirokchilar o'rtasida aniqlanadi. Tanlovning ikkinchi bosqichi g'oliblar eng ko'p referal to'plagan ishtirokchilar o'rtasida o'tkaziladigan mantiqiy savollarga to'g'ri javob berish orqali aniqlanadi. \n\n 1-o'rin - 300000 so'm \n 2-o'rin - 200000 so'm \n 3-o'rin - 100000 so'm \n\n Rag'batlantiruvchi o'rinlar egalariga esa turli (1 oylik va 3 oylik telegram premium) sovg'alar topshiriladi.\n\n Sizning referal linkingiz:  {referral_link}")


@dp.message(lambda message: message.text == "Test")
async def show_rules(message: types.Message):
    rules = """
    Test 18-fevral kuni 18:00 da boshlanadi va 19:00 da tugaydi!
    """
